...
<body>
<?php 
$pageLocation = "archive-products.php";
include ("sidebar.php"); 
?>
<!-- CONTENT -->
<section id="content">
    ...
    <main style="overflow: auto; padding: 10px 24px;">
        <div class="head-title">
            ...
            <div class="settings-buttons">
                ...
                <div><button class="active" role="button" onclick="location.href='archive-products.php';setActive(this);">Archive</button></div>
            </div>

            <div class="table-data">
                <div class="archive-products-list">
                     <div class="head archive-products-title" style="margin-bottom: 0">
                        ...
                        <div class="archive-buttons">
                            ...
                            <div><button class="active" role="button" onclick="location.href='archive-products.php';setActive(this);">Products</button></div>
                    ...
                    <div class="archive-products-table">
                    <table class="table" id="archiveProduct_tbl">
                        <thead>
                            <tr>
                    ...
                    <div id="Archiveproduct_pagination">
...
<script src="./js/fetchdata-archiveProduct.js"></script>
