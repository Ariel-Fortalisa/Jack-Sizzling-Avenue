...
<body>
<?php 
$pageLocation = "archive-category.php";
include ("sidebar.php"); 
?>
<!-- CONTENT -->
<section id="content">
    ...
    <main style="overflow: auto; padding: 10px 24px;">
        <div class="head-title">
            ...
            <div class="settings-buttons">
                ...
                <div><button class="active" role="button" onclick="location.href='archive-category.php';setActive(this);">Archive</button></div>
            </div>

            <div class="table-data">
                <div class="archive-category-list">
                    <div class="head archive-category-title" style="margin-bottom: 0">
                        ...
                        <div class="archive-buttons">
                            ...
                            <div><button class="active" role="button" onclick="location.href='archive-category.php';setActive(this);">Category</button></div>
                    ...
                    <table class="table" id="archiveCategory-tbl">
                        <thead>
                            <tr>
                    ...
                    <div class="archivecategory_pagination">
...
<script src="./js/fetchdata-archiveCategory.js"></script>
