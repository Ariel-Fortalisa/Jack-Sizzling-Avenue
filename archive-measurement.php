...
<head>
    ...
    <title>Archive Measurement</title>
</head>
<style>
   #content main {
...
<body>
<?php 
$pageLocation = "archive-measurement.php";
include ("sidebar.php"); 
?>
<!-- CONTENT -->
<section id="content">
    ...
    <main style="overflow: auto; padding: 10px 24px;">
        <div class="head-title">
            ...
            <div class="settings-buttons">
                ...
                <div><button class="active" role="button" onclick="location.href='archive-measurement.php';setActive(this);">Archive</button></div>
            </div>
            
            <div class="table-data">
                <div class="archive-measurement-list">
                <div class="head archive-measurement-title" style="margin-bottom: 0">
                        <h4>Archive Measurement</h4>
                        <div class="archive-buttons">
                            ...
                            <div><button class="active" role="button" onclick="location.href='archive-measurement.php';setActive(this);">Measurement</button></div>
                        </div>
                    </div>
                    ...
                    <div class="archive-measurement-table">
                    <table class="table" id="archivemeasurement_tbl">
                        <thead>
                            <tr>
                    ...
                    <div class="measurement_pagination">
...
<script src="./js/fetchdata-archiveMeasurement.js"></script>
</body>
</html>
