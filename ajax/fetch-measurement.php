...
if ($request === "unit") {
    ...
    $whereQuery = 'WHERE 1=1 AND archive_status = 0';
    ...
    $dataCount = $conn->query("SELECT COUNT(*) as data_count FROM unit_of_measurement WHERE archive_status = 0 AND unit_name LIKE '%$search%'")->fetch_assoc()["data_count"];
