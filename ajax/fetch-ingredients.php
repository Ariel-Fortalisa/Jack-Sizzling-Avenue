...
if ($request === "items") {
   ...
   SELECT *,
    ...
    INNER JOIN users u ON stock.added_by = u.user_id
    ";
    ...
    $dataCount = $conn->query("SELECT COUNT(*) as data_count FROM stocks WHERE archive_status = 0 AND stock_name LIKE '%$search%'")->fetch_assoc()["data_count"];
